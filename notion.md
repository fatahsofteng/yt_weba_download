...
### **3.1 Downloading audio files (Audio Download)**
 ...
 ✔ Download the highest bit rate version if only compressed audio is available
...
1. **Sample Rate ≥ 16 kHz (44.1k or 48k recommended)**
2. **If the non-speaker separates the multi-tracks, convert all to Mono.**
3. **Output filename = video ID, e.g.:**
